package com.kalinrx.shared.termux;
 ...
 *
 * - 0.34.0 (2021-10-26)
 *      - Move `RESULT_SENDER` to `com.kalinrx.shared.shell.command.ShellCommandConstants`.
 *
 * - 0.35.0 (2022-01-28)
...
public final class TermuxConstants {
    ...
    /** Termux app name */
    public static final String TERMUX_APP_NAME = "AnKali"; // Default: "Termux"
    /** Termux package name */
    public static final String TERMUX_PACKAGE_NAME = "com.kalinrx"; // Default: "com.termux"
    ...
    /** Termux:API app name */
    public static final String TERMUX_API_APP_NAME = "AnKali:API"; // Default: "Termux:API"
    ...
    public static final String TERMUX_STYLING_APP_NAME = "AnKali:Styling"; // Default: "Termux:Styling"
    ...
    public static final String TERMUX_WIDGET_APP_NAME = "AnKali:Widget"; // Default: "Termux:Widget"
    ...
    public static final class TERMUX_APP {
        ...
        public static final class TERMUX_SERVICE {
            ...
            /** Intent {@code String} extra for custom log level for background commands defined by {@link com.kalinrx.shared.logger.Logger} for the TERMUX_SERVICE.ACTION_SERVICE_EXECUTE intent */
        ...
        public static final class RUN_COMMAND_SERVICE {
            ...
            /** Intent {@code String} extra for custom log level for background commands defined by {@link com.kalinrx.shared.logger.Logger} for the RUN_COMMAND_SERVICE.ACTION_RUN_COMMAND intent */
