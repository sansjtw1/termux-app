...
import com.termux.R;
import com.kalinrx.app.event.SystemEventReceiver;
import com.kalinrx.app.terminal.TermuxTerminalSessionActivityClient;
import com.kalinrx.app.terminal.TermuxTerminalSessionServiceClient;
import com.kalinrx.shared.termux.plugins.TermuxPluginUtils;
import com.kalinrx.shared.data.IntentUtils;
import com.kalinrx.shared.net.uri.UriUtils;
import com.kalinrx.shared.errors.Errno;
import com.kalinrx.shared.shell.ShellUtils;
import com.kalinrx.shared.shell.command.runner.app.AppShell;
import com.kalinrx.shared.termux.settings.properties.TermuxAppSharedProperties;
import com.kalinrx.shared.termux.shell.command.environment.TermuxShellEnvironment;
import com.kalinrx.shared.termux.shell.TermuxShellUtils;
...
import com.kalinrx.shared.termux.TermuxConstants.TERMUX_APP.TERMUX_SERVICE;
import com.kalinrx.shared.termux.settings.preferences.TermuxAppSharedPreferences;
import com.kalinrx.shared.termux.shell.TermuxShellManager;
...
import com.kalinrx.shared.notification.NotificationUtils;
import com.kalinrx.shared.android.PermissionUtils;
import com.kalinrx.shared.data.DataUtils;
import com.kalinrx.shared.shell.command.ExecutionCommand;
import com.kalinrx.shared.shell.command.ExecutionCommand.Runner;
import com.kalinrx.shared.shell.command.ExecutionCommand.ShellCreateMode;
    ...
    private synchronized void killAllTermuxExecutionCommands() {
        ...
        for (int i = 0; i < pendingPluginExecutionCommands.size(); i++) {
            ...
            if (!executionCommand.shouldNotProcessResults() && executionCommand.isPluginExecutionCommandWithPendingResult()) {
                if (executionCommand.setStateFailed(Errno.ERRNO_CANCELLED.getCode(), this.getString(com.kalinrx.shared.R.string.error_execution_cancelled))) {
