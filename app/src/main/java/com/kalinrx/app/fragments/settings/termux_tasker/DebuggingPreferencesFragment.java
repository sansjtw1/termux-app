package com.kalinrx.app.fragments.settings.termux_tasker;
...
import com.termux.R;
import com.kalinrx.shared.termux.settings.preferences.TermuxTaskerAppSharedPreferences;
...
public class DebuggingPreferencesFragment extends PreferenceFragmentCompat {
    ...
    private void configureLoggingPreferences(@NonNull Context context) {
        ...
        if (logLevelListPreference != null) {
            ...
            com.kalinrx.app.fragments.settings.termux.DebuggingPreferencesFragment.
